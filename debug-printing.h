...
// Printing macros for cluster: OptTunnel
#if defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_OPT_TUNNEL_CLUSTER)
#define emberAfOptTunnelClusterPrint(...) emberAfPrint(EMBER_AF_PRINT_OPT_TUNNEL_CLUSTER, __VA_ARGS__)
#define emberAfOptTunnelClusterPrintln(...) emberAfPrintln(EMBER_AF_PRINT_OPT_TUNNEL_CLUSTER,  __VA_ARGS__)
// Blocking IO is enabled for all serial ports, therefore flush calls are unnecessary.
#define emberAfOptTunnelClusterFlush()
#define emberAfOptTunnelClusterDebugExec(x) if ( emberAfPrintEnabled(EMBER_AF_PRINT_OPT_TUNNEL_CLUSTER) ) { x; }
#define emberAfOptTunnelClusterPrintBuffer(buffer, len, withSpace) emberAfPrintBuffer(EMBER_AF_PRINT_OPT_TUNNEL_CLUSTER, (buffer), (len), (withSpace))
#define emberAfOptTunnelClusterPrintString(buffer) emberAfPrintString(EMBER_AF_PRINT_OPT_TUNNEL_CLUSTER, (buffer))
#else
#define emberAfOptTunnelClusterPrint(...)
#define emberAfOptTunnelClusterPrintln(...)
#define emberAfOptTunnelClusterFlush()
#define emberAfOptTunnelClusterDebugExec(x)
#define emberAfOptTunnelClusterPrintBuffer(buffer, len, withSpace)
#define emberAfOptTunnelClusterPrintString(buffer)
#endif //defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_OPT_TUNNEL_CLUSTER)
